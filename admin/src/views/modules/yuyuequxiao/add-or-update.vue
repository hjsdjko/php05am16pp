	...
	<div class="addEdit-block" :style='{"padding":"0px 0px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="预约内容" prop="yuyueneirong">
					<el-input v-model="ruleForm.yuyueneirong" placeholder="预约内容" clearable  :readonly="ro.yuyueneirong"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="预约内容" prop="yuyueneirong">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="取消时间" prop="quxiaoshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.quxiaoshijian" label="取消时间" prop="quxiaoshijian">
					<el-input v-model="ruleForm.quxiaoshijian" placeholder="取消时间" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="textarea" v-if="type!='info'" label="取消原因" prop="quxiaoyuanyin">
					<el-input
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.quxiaoyuanyin" label="取消原因" prop="quxiaoyuanyin">
					<span :style='{"border":"2px solid #c8c8c8","padding":"0 20px","color":"inherit","background":"none","display":"inline-block","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"350px","fontWeight":"500"}'>{{ruleForm.quxiaoyuanyin}}</span>
				</el-form-item>
