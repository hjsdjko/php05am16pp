<template>
	<div class="addEdit-block" :style='{"padding":"0px 0px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'" label="医生账号" prop="yishengzhanghao">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.yishengzhanghao" label="医生账号" prop="yishengzhanghao">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="性别" prop="xingbie">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="擅长" prop="shanzhang">
					<el-input v-model="ruleForm.shanzhang" placeholder="擅长" clearable  :readonly="ro.shanzhang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="擅长" prop="shanzhang">
					<el-input v-model="ruleForm.shanzhang" placeholder="擅长" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="挂号费用" prop="guahaofeiyong">
					<el-input v-model.number="ruleForm.guahaofeiyong" placeholder="挂号费用" clearable  :readonly="ro.guahaofeiyong"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="挂号费用" prop="guahaofeiyong">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="坐诊时间" prop="zuozhenshijian">
					<el-input v-model="ruleForm.zuozhenshijian" placeholder="坐诊时间" clearable  :readonly="ro.zuozhenshijian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="坐诊时间" prop="zuozhenshijian">
